...
(21, 12, '2026-01-19', 'present', '14:52:37', 0.00000000, 0.00000000, '17:05:00', '', NULL, '2026-01-19 09:07:37'),
(22, 16, '2026-01-19', 'present', '15:16:54', 0.00000000, 0.00000000, '17:06:00', '', NULL, '2026-01-19 09:31:54'),
(23, 12, '2026-01-20', 'present', '10:44:13', 0.00000000, 0.00000000, '14:30:29', '', NULL, '2026-01-20 04:59:13'),
...
INSERT INTO `communication_logs` (`id`, `recipient_email`, `candidate_name`, `subject`, `message`, `sent_at`) VALUES
...
CREATE TABLE `employees` (
  ...
  `casual_balance` int(11) DEFAULT 7,
  `annual_balance` int(11) DEFAULT 15,
  `maternity_balance` int(11) DEFAULT 90,
  `emergency_balance` int(11) DEFAULT 3
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `employees` (`id`, `user_id`, `employee_id`, `first_name`, `last_name`, `leave_balance`, `email`, `phone`, `department`, `designation`, `hire_date`, `salary`, `status`, `created_at`, `updated_at`, `sick_balance`, `casual_balance`, `annual_balance`, `maternity_balance`, `emergency_balance`) VALUES
(7, 4, 'Emp004', 'Aayush', 'Sharma', 20, 'aayush.sharma@peoplenest.com', '', 'IT', 'Developer', '2026-01-06', 0.00, 'active', '2026-01-06 14:18:42', '2026-01-06 14:18:42', 10, 7, 15, 90, 3),
(10, 8, 'Emp105', 'Ritika', 'Chaudhary', 20, 'ritikachy002@peoplenest.com', '9827737372', 'Finance', 'finance manager', '2026-01-10', 60000.00, 'active', '2026-01-10 07:37:21', '2026-01-24 12:29:45', 7, 7, 15, 90, 3),
(12, 10, 'Emp107', 'Kim', 'Jung', 14, 'kimjung012@peoplenest.com', '9827272735', 'Marketing', 'senior marketing manager', '2026-01-02', 60000.00, 'active', '2026-01-11 07:01:52', '2026-01-24 14:08:27', 8, 5, 15, 90, 2),
(13, 11, 'Emp108', 'sita', 'chaudhary', 20, 'rit@gmail.com', '9875431456', 'IT', 'developer', '2026-01-11', 50000.00, 'active', '2026-01-11 08:10:48', '2026-01-12 02:32:59', 10, 7, 15, 90, 3),
(14, 13, 'Emp109', 'samira', 'magar', 20, 'samira506@peoplenest.com', '9856990566', 'IT', 'accountant', '2026-01-12', NULL, 'active', '2026-01-12 10:13:46', '2026-01-12 10:13:46', 10, 7, 15, 90, 3),
...
(8, 10, 'sick', '2026-01-19', '2026-01-21', 3, 'i am sick', 'approved', 1, '2026-01-24 12:29:45', NULL, '2026-01-19 05:25:29', '2026-01-24 12:29:45'),
(9, 12, 'casual', '2026-01-23', '2026-01-24', 2, 'i need holiday', 'approved', 1, '2026-01-24 12:29:40', NULL, '2026-01-19 08:36:58', '2026-01-24 12:29:40'),
...
(11, 12, 'sick', '2026-01-21', '2026-01-22', 2, 'i need leave', 'approved', 1, '2026-01-24 12:29:09', NULL, '2026-01-21 01:42:21', '2026-01-24 12:29:09'),
(12, 12, 'emergency', '2026-01-25', '2026-01-25', 1, 'gbipooyhufyghubijkl;', 'approved', 1, '2026-01-24 14:08:27', NULL, '2026-01-24 12:41:10', '2026-01-24 14:08:27');
...
(6, 1, 'New Sick leave request from Kim Jung (2 days).', 1, '2026-01-21 01:42:21'),
(7, 10, 'Your Sick request from 2026-01-21 has been APPROVED. ????', 0, '2026-01-24 12:29:09'),
...
(16, 'Emp112', 'meerakapoor', 'ritikachy231@gmail.com', '$2y$10$dKzXP8vzlzf2Z/BNkT22ZeSxGlg7Kw0HALtRRslADlI36DYMWI.7G', 'employee', '2026-01-23 15:33:26', '2026-01-23 15:33:26');
